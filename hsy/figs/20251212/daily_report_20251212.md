# Daily Market Report (LLM-ready) — 2025-12-12
...
- Best performer: **GOLD** (0.554%)
- Worst performer: **BITCOIN** (-2.425%)
- Highest intraday range: **BITCOIN** (3.476%)
- Risk regime inference: **Risk-off (provisional)** (score=-1.75)
  - Evidence:
    - Equity mean return: -1.064%
    - USD/KRW return: -0.050% (inverse tilt)
    - DXY return: 0.081% (inverse tilt)
    - Gold return: 0.554% (weak inverse tilt)
    - US10Y change proxy (ret_pct): 0.383% (context only)
